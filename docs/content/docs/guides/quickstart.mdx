...
If the agent crashes, the container remains available to `typeclaw logs`. Before a later stop or restart removes it, TypeClaw saves its timestamped output under `.typeclaw/logs/` in the agent folder.
